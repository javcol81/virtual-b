...
<body>
    ...
    <form action="{{route('template.evento')}}" method="POST">
      @csrf
            ...
            <div class="row">
                <div class="col-12">
                    <div class="shopping-cart-total d-flex align-items-center">
                        ...
                        <button href="#" class="btn btn-success ml-auto comprarButton">Comprar</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <script src="{!! asset('estilo/js/tienda.js') !!}"></script>
